...
var BootScene = new Phaser.Class({
  ...
  preload: function () {
    ...
    // map in json format
    this.load.tilemapTiledJSON("map", "assets/tane-rpg.json");

    //taha images
    this.load.image("taha1", "assets/taha1.png");
    this.load.image("taha2", "assets/taha2.png");
    this.load.image("taha3", "assets/taha3.png");
    this.load.image("taha4", "assets/taha4.png");

    // our player
    this.load.spritesheet("player", "assets/rpg-girl-sprite.png", {
      frameWidth: 17,
      frameHeight: 17,
    });

    // our enemies
    this.load.spritesheet("enemies", "assets/four-monsters.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
